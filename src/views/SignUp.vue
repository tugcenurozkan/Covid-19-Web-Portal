 <template>
    ...
    <div class="container " style=" background-color: rgb(94, 94, 94);">
      <form class="vue-form" @submit.prevent="submit" style="background-color:  rgb(170, 170, 170)">
  ...
  <fieldset>
    ...
    <div>
      <label class="label" for="isim">İsim</label>
      <input type="text"  placeholder="İsim Giriniz" name="isim" id="isim" required="" v-model="isim" style="background-color: rgb(199, 199, 199)" >
    </div>

    <div>
    <label class="label" for="soyisim">Soyisim</label>
    <input type="text"  placeholder="Soyisim Giriniz" name="name" id="soyisim" required="" v-model="soyisim" style="background-color: rgb(199, 199, 199)">
  </div>

    <div>
      <label class="label" for="email">Email</label>
      <input type="email" placeholder="tugcenurozkan@gmail.com"  name="email" id="email" required=""
             :class="{ email , error: !email.valid }"
             v-model="email.value" style="background-color: rgb(199, 199, 199)">
    </div>

    <div >
    <label class="label" for="parola">Parola</label>
        <input type="password" placeholder="Parola Giriniz" id="parola" class="form-control" v-model="parola" style="background-color: rgb(199, 199, 199)">
            
</div>

    <div>
      <label class="label" for="textarea">Eklemek İstedikleriniz</label>
      <textarea class="message" name="textarea" id="textarea" required="" 
                v-model="message.text" 
                :maxlength="message.maxlength" style="background-color: rgb(199, 199, 199)"></textarea>
      <span class="counter">{{ message.text.length }} / {{ message.maxlength }}</span>
    </div>
    <div>
      <input type="submit" value="Gönder" @click="submit">
    </div>
  </fieldset>
</form>
